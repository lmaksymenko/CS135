...
#|-------------------------------------------------------------------------------
 ...
 | Pledge:I peldge my honor that ive abided b stevens honor code
 |-------------------------------------------------------------------------------|#
...
(define (rotate c)
 ...
 ;( cons (car c) (cdr c) ) tha datatype
  
  (list (list  (car c) (car (cdr c)) )  (list (car (cdr c)) (-(car c))) (list (-(car c)) (-(car (cdr c))) )   (list (-(car (cdr c))) (car c)) )
...
(define (combine-courses s1 s2)
  ...
  (let ( [cs1  (cdr(cddddr s1))]   [cs2 (cdr(cddddr s2))] ) 
   
   (append (car cs1) (car cs2))
